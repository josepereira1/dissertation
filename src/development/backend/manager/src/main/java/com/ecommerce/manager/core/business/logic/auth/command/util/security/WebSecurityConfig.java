...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static void sendErrorMessage(HttpServletRequest request, HttpServletResponse response, Exception e) throws IOException {
        ...
        pw.print(Response.builder().service("employee").timestamp(LocalDateTime.now()).status(ResponseStatus.ERROR).appCode(Response.AUTHENTICATION_FAIL).message(e.getMessage()).build());
        pw.flush();
    }
}
