package com.ecommerce.cp.outbound.messaging.cqrs.product.updateproduct;
...
@Service
public class CQRSUpdateProduct implements ICQRSUpdateProduct {

    @Value("${cqrs.0.update.product.routing.key}")
    private String routingKey;

    @Value("${cqrs.0.update.product.method.name}")
