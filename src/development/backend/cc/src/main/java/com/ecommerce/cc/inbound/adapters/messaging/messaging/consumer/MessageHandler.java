package com.ecommerce.cc.inbound.adapters.messaging.messaging.consumer;

import com.ecommerce.cc.core.business.logs.ILogs;
import com.ecommerce.cc.core.business.messaging.logic.IMessagingBusiness;
...
public abstract class MessageHandler {
    ...
    @Autowired
    private IMessagingBusiness communicationBusinessLogic;
    ...
    public void handleMessage(String json){
        ...
        try{
            IMessage message;
            try {
                message = communicationBusinessLogic.fromJson(json);
