package com.ecommerce.sc.inbound.messaging.sagas.updateproduct;
...
@Service
public class UpdateProductSagaMethodNames implements ISagaMethods {

    @Value("${update.product.saga.0.sc.local.transaction.method.name}")
    private String localTransaction;

    @Value("${update.product.saga.0.sc.compensating.transaction.method.name}")
