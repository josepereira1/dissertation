package com.ecommerce.qp.inbound.messaging.cqrs.product.update.jsons;
/*
...
import com.ecommerce.qp.inbound1.messaging.cqrs.product.update.mappers.in.dtos.UpdateProductFeatureProductDTO;
import com.google.gson.*;
import java.lang.reflect.Type;

public class UpdateProductFeatureProductDTODeserializer implements JsonDeserializer<UpdateProductFeatureProductDTO> {
    @Override
    public UpdateProductFeatureProductDTO deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        UpdateProductFeatureProductDTO product = new UpdateProductFeatureProductDTO();
