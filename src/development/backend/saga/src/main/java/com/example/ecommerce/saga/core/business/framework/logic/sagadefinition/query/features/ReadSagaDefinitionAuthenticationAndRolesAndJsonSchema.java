...
@Service
public class ReadSagaDefinitionAuthenticationAndRolesAndJsonSchema {

    @Autowired
    private IQuerySagaDefinitionRepository querySagaDefinitionRepository;

    public SagaDefinition readSagaDefinitionAuthenticationAndRolesAndJsonSchema(String id) throws SagaDefinitionNotExistsException {
        Optional<SagaDefinition> optional = querySagaDefinitionRepository.findAuthenticationAndRolesAndJsonSchema(id);
